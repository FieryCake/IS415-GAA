...
## Global measures of auto correlation
### Computing weights
```{r}
wm_q <- poly2nb(hunan, 
                queen=TRUE)
...
## Derive Spatially lagged variables of interests and centers the spatially lagged variable around its mean

hunan$lag_GDPPC <- lag.listw(rswm_q, hunan$GDPPC)
DV <- hunan$lag_GDPPC - mean(hunan$lag_GDPPC)   
```

## centering moran around the mean
```{r}
