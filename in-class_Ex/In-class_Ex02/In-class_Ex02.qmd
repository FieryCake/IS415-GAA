...
Write a code chunk to convert the data type to date-time
(using lubridate to convert ping time to date-time)
(override existing dataset with df$ - can also use mutate)
:::
...
Write a code chunk to 
- Extract trip origin location
- derice three new column, weekday, starting hour and day of the month
...
Write a code chunk to 
- Extract trip destination location
- derice three new column, weekday, starting hour and day of the month
- name the output tibble data.frame origin_df
:::
