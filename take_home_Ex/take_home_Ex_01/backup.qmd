...
```{r}
# Plot the polygonal boundary
plot(sg_owin, xlim = c(2667.54, 51403.96), ylim = c(21494.3, 50256.33))

# Add the point pattern within the rectangle
points(grabSg_ppp, col = "red")
